...
root.title("Brain tummor and classification detection ")
...
#
label_l1 = tk.Label(root, text="Brain tummor and classification detection",font=("Times New Roman", 35, 'bold'),
