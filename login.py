...
image2 =Image.open('B2.jpeg')
image2 =image2.resize((1350,800), )
...
# background_label.place(x=700, y=0) #, relwidth=
...
title=tk.Label(root, text="sign in", font=("Algerian", 30, "bold","italic"),bd=5,bg="white",fg="black")
title.place(x=500,y=100,width=250)
        
Login_frame=tk.Frame(root,bg="white")
Login_frame.place(x=400,y=200)
        
logolbl=tk.Label(Login_frame,image=bg_icon,bd=0).grid(row=0,columnspan=2,pady=30)
